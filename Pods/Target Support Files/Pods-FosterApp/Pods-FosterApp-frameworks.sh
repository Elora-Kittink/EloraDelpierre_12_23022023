...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/CoreDataUtilsKit/CoreDataUtilsKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/NetworkUtilsKit/NetworkUtilsKit.framework"
